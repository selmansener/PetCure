namespace PetCure.Domains.PatientManagement
{
    public class Pet : BaseEntity
    {
        ...
        public Pet(string name, string species, string breed, string gender, DateTime dateOfBirth, float weight, string color, string microChipId, int ownerId, string medicalHistory)
        {
            Name = name;
            Species = species;
            Breed = breed;
